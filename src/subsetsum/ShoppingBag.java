...
public class ShoppingBag 
{
	...
	{
		//Create a GroceriesFileReader object, reader.
		GroceriesFileReader reader = new GroceriesFileReader();

		//Uses 'readFile' function in 'reader' to populate 'priceOfGroceries' array list with item prices.
	...
	public static void main(String[] args) 
	{
		...
		// populates 'purchases' with a list of items/prices, according to the given budget.
